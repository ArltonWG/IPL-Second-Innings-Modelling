...
```{r overstats}
overstats = overview
#tot_matches = 884 #Should come through in previous files
...
```{r dimensions}
dimensions = read_excel("Stadiums/Stadiums.xlsx",sheet = "Sheet1")
...
save.image(file='Match Grouping.RData')
