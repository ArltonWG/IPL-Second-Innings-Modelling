...
train_full = data_format[c(1:741),]
test_full = data_format[c(742:dim(data_format)[1]),] #the last season of results
...
ggsave(paste0('C:/Users/arlto/My Drive/Arlton Gilbert MSc/Write-up/Current Version/images/',image_file))
...
# 1. Open jpeg file
jpeg(paste0('C:/Users/arlto/My Drive/Arlton Gilbert MSc/Write-up/Current Version/images/',image_file), width = 450, height = 450)
# 2. Create the plot
# compare OOB errors:
plot(rf_cric$err.rate[, 'OOB'], type = 's', xlab = 'Number of trees', ylab = 'OOB error', col = 'red', main = "Out of Bag Error Comparison")
lines(bag_cric$err.rate[, 'OOB'], col = 'black', type = 's')
...
save.image(file='10 Modelling.RData')
